...
const 항목목록 = ['매출액', '영업이익', '인건비', '유형자산', '감가상각비', '이자비용',
                  '매출원가', '판관비', '당기순이익', '법인세비용', '무형자산', '이연법인세', '법인세납부액'];
...
아래 13개 항목 각각에 대해 CSV에서 해당하는 값을 찾아 반환하세요: 매출액, 영업이익, 인건비, 유형자산, 감가상각비, 이자비용, 매출원가, 판관비, 당기순이익, 법인세비용, 무형자산, 이연법인세, 법인세납부액.
추가 항목의 흔한 표현: "판관비"="판매비와관리비"/"판매비및일반관리비", "당기순이익"="당기순이익(손실)", "법인세비용"="법인세비용(수익)", "이연법인세"="이연법인세자산"(자산이면 양수)/"이연법인세부채"(부채이면 음수), "법인세납부액"="법인세납부"/"법인세 납부액"(현금흐름표).
